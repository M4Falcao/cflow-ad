...
__all__ = ('MVTecDataset', 'StcDataset', 'InspladDataset')
...
INSPLAD_CLASS_NAMES = ['glass-insulator', 'lightning-rod-suspension', 'polymer-insulator-upper-shackle', 'vari-grip', 'yoke-suspension']

class InspladDataset(Dataset):
    def __init__(self, c, is_train=True):
        assert c.class_name in INSPLAD_CLASS_NAMES, 'class_name: {}, should be in {}'.format(c.class_name, INSPLAD_CLASS_NAMES)
    ...
    def load_dataset_folder(self):
        ...
        for img_type in img_types:
            ...
            if img_type == 'good' or img_type == 'normal':
